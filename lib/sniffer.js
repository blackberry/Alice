...
var sniffer = {
    ...
    init: function () {
        ...
        if (this.score !== 1) {
            ...
            div.innerHTML     = '';
            div.innerHTML    += 'It appears your browser does not support <b>' + this.fail + '</b> of the CSS3 properties used by Alice. Please use a <b>WebKit-based</b> browser like Chrome, Safari or the PlayBook Browser.';
