...
var sniffer = {
    ...
    init: function () {
        ...
        if (this.score !== 1) {
            ...
            div.innerHTML     = '';
            div.innerHTML    += 'It appears your browser does not support all of the CSS3 properties used by Alice. Please use a <b>WebKit-based</b> browser like Chrome, Safari or the PlayBook Browser.';
    ...
    // confirm if property exists, output true/false
    ...
    calcScore: function () {
        ...
        var fail = 0;
        for (var prop in this.properties) {
            this.properties[prop] === true ? pass++ : fail++;
            total++;
        }
        this.score = pass / total;
